...
class AccountsScreen extends StatelessWidget {
  final List<Account> accounts = [
    Account(name: 'Cuenta 1', institucion: 'UNI', imageAssetPath: 'assets/doctor.png'),
    Account(name: 'Cuenta 2', institucion: 'UNI', imageAssetPath: 'assets/doctor.png'),
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Column(
        children: [
          Text('Lista de Psicológos', style: TextStyle(
            fontSize: 28,
